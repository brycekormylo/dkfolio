...
const about_millie = [
	...
	"This sassy and goofy girl is all about comfort, whether it’s her memory foam beds, pillows or hammocking, which has now become a weekend ritual. If Millie doesn’t get her hammock time, she throws a full-on tantrum. Spoilt? Absolutely. But with her charm, who can resist?! She’ll ask to be swung and sleep there for hours, even trying to swing herself sometimes. Her VIP experience wouldn’t be complete without a pillow, blanket, and music or Harry Potter audiobooks playing in the background. Like we said, spoilt AF.",
];
