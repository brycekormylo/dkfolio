...
const about_dogs = [
  "Charlie, our resident Ravenclaw, is an Australian shepherd who thrives on challenges, both physical and mental. She delights in road trips, she's a whiz at beach frisbee, loves to show off, and will do anything for top-notch snacks! As a creative genius with boundless energy, Charlie has an unmatched love for high-quality treats. She's constantly teaching herself new tricks just to indulge in her favourite snacks. This affectionate ball of joy can brighten anyone's day, forcing you to love her whether you want to or not! When Charlie isn't conquering the great outdoors or camping, she likes to kick back by watching her favourite shows and movies like Avatar The Last Airbender, Korra, Moana, and Shrek! Of course, the experience isn't complete until she peacefully dozes off with a ball in her mouth stretched out like a little bear rug.",
