...
function ContactForm() {
	...
	return (
		<div className="flex justify-center items-center py-8 rounded-2xl bg-timber/50 shadow-neo md:h-[32rem] md:min-w-[42rem] dark:bg-smoke/75 dark:shadow-neodark">
			<div
				className={`${
			...
			>
				...
				<p className="px-10 text-xs text-center opacity-80 md:text-sm">
			...
			>
				...
				>
					...
					<button
						...
						className="py-2 px-4 text-base bg-white rounded-xl transition-all ease-linear md:text-xl dark:bg-black border-[1px] border-black/50"
					>
